...
describe RobotApp::BadBoard do
  subject {RobotApp::BadBoard.new}
  ...
  context 'action that will make object fall off' do
    it "robot will fall off, throws error" do
      expect{subject.take_action(robot){action3}}.to raise_error
    end
  end
